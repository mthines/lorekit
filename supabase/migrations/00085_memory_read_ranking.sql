...
-- migration 00084 shipped is NOT "never read" — it is "not read since 00084
...
comment on function lorekit_memory_read_ranking(uuid, text, text, integer, text[]) is
  'Memories ranked by read_count (migration 00084) — hot (most-read first) or
   ...
   lorekit_memory_scopes. read_count = 0 means "not read since 00084 started
