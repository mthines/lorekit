...
A filter carrying leading or trailing whitespace is a **400** as well: the grammar check trims before it looks, but the predicate does not, so the padded form could only ever match nothing.
