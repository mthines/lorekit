 ...
 *   2. `packages/mcp-core/src/tools/list.ts` — the `@lorekit/core` reference
 *      implementation.
 ...
 * paths could return previews of different lengths, and nothing would fail.
 * Assert all four agree, following the `usage-client-parity.spec.ts` precedent
