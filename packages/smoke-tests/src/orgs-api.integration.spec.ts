 ...
 *     pnpm nx test smoke-tests -- --reporter=verbose --testPathPattern=orgs-api.integration
 */
...
/**
 * A token's permissions are encoded in its prefix (`packages/mcp-core/src/auth/permissions.ts`):
 ...
 *     structural guard (`packages/mcp-core/src/audit/audit-coverage.spec.ts`) proves
