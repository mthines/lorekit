  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <TutorialCallout variant="tip">
        ...
        self-host your own. This tutorial uses the hosted instance. For self-hosting
        see the{' '}
        <a
      ...
      <div className="flex flex-col">
        <TutorialStep number={1} title="Generate an API token">
          <p>
            Go to <strong>Overview → Connect your agent</strong> and click{' '}
            <strong>Generate new token</strong>. Enter a name (e.g.{' '}
    ...
    LOREKIT_TOKEN: \${{ secrets.LOREKIT_TOKEN }}`}</code></pre>
        ...
        <TutorialStep number={6} title="(Optional) Set up the GitHub webhook">
            <p>
              ...
              <strong>Settings → Webhooks</strong>, add your repo{' '}
              (<code>owner/repo</code>), copy the generated secret, then configure a
              webhook on GitHub pointing at your MCP endpoint:
            </p>
            <ul className="mt-2 list-disc pl-5 space-y-1">
      ...
      <TutorialCallout>
        ...
        <a href="/tutorials/organization" className="text-[var(--color-accent)] underline underline-offset-2">
