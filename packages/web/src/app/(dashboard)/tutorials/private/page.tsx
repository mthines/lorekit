...
// No "org" parameter → personal, only you can read it.`}</code></pre>
        ...
        <TutorialStep number={2} title="Understand what happens at a bound scope">
          ...
          <ul className="mt-2 list-disc pl-5 space-y-1">
            <li>
              ...
              Explicitly pass <code>org: undefined</code> (or pass <em>no</em> org key)
              with a different scope to write personal instead.
            </li>
            <li>
          ...
          <TutorialCallout variant="tip">
            ...
            scope that is not bound (e.g. a branch scope:{' '}
        ...
        <TutorialStep number={3} title="Filter to personal lore in the Explorer">
          <p>
            In the <strong>Explorer</strong>, use the <strong>Personal</strong> filter in
            the <strong>All · Personal · {'{org}'}</strong> toolbar. This narrows the list
            to lessons that belong only to you — org-owned lessons are hidden.
          </p>
        </TutorialStep>
  ...
  force: true
      ...
      <TutorialCallout>
        ...
        <a href="/tutorials/tags" className="text-[var(--color-accent)] underline underline-offset-2">
