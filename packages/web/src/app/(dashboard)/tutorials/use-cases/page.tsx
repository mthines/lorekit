    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-sm text-[var(--color-content-secondary)]">
          The <code>aw</code> agent dispatcher reads lessons at Phase 1 (planning) and writes new
          ones at Phase 4 (stuck-loop) and Phase 7 (end-of-run). Universal lessons are written to
  ...
  trigger:      "stuck-loop"
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-sm text-[var(--color-content-secondary)]">
          ...
          the same context as local agents.
        </p>
        <UseCase
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-sm text-[var(--color-content-secondary)]">
          ...
          so every team member's agent gets the same context automatically.
        </p>
        <UseCase
...
// → includes the org-owned entry for every member`}
        ...
        <UseCase
          ...
          code={`// Admin binds the scope from Settings → Shared scopes
  ...
  // no "org" needed — binding routes it automatically
      ...
      <div className="flex flex-col gap-4">
        ...
        <p className="text-sm text-[var(--color-content-secondary)]">
          ...
          set until you're ready to promote them.
        </p>
        <UseCase
...
memory.delete {
  ...
  key:   "cache-invalidation-strategy"
      ...
      <TutorialCallout variant="tip">
        The CLI <code>npx @lorekit/cli tree</code> command shows the full scope
        precedence hierarchy — which lesson wins per key, and which are shadowed — so you
        can audit exactly what an agent will see before a task.
      </TutorialCallout>
    </div>
  );
}
