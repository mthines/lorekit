 ...
 *
 * Content lives in GettingStartedContent (shared with the login page) so there
 * is one source of truth for the three-step setup flow. The TutorialCard chrome
 * stays here because it is a dashboard-specific layout wrapper.
 *
