...
/**
 * A numbered step block for Learn pages. Renders the step number as an amber
 * circle badge and the title as an h3 (proper heading within the page's h2
 * section). Keeps the visual language consistent across all tutorial pages
  ...
  return (
    <div className="flex gap-4 pb-8">
      ...
      <div className="min-w-0 flex-1">
        <h3 className="mb-2 text-sm font-medium text-[var(--color-content-primary)]">{title}</h3>
