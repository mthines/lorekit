 ...
 *
 * The wording decisions (what a badge counts, how the sentence reads, which
 * wildcards the picker offers) live in `lib/token-scoping.ts` with its own
 * unit tests. What lives here is the rendering and the interaction.
 */
