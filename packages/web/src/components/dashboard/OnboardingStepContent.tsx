...
function ConnectStep({
  ...
  const snippetUrlWithToken = `${vanityMcpUrl}?token=${activeToken}`;
  ...
  // Snippets use vanityMcpUrl so users copy the stable lorekit.io URL.
  const clientConfigs: McpClientConfig[] = MCP_CLIENTS.map((c) => ({
    ...
    filename: c.filename,
    hint: c.hint,
    snippet: c.buildConfig(snippetUrlWithToken),
  }));
