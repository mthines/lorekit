...
This scaffolds the `lorekit-memory` and `lorekit-setup` skills, the local MCP server, and the lifecycle hooks into your `.claude/` (project) or `~/.claude/` (global) directory.
