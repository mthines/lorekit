...
Memories are ranked before the budget is spent, so the ones that survive are the most-recurring and most-recent, not merely the newest. When the budget runs out, the shape decides what happens to the rest:
