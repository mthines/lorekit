...
To have LoreKit automatically learn from PR review comments, go to [Settings → Webhooks](/settings/webhooks), add your repo (`owner/repo`), copy the generated secret, then configure a webhook on GitHub pointing at your MCP endpoint:

- **Payload URL:** `…/functions/v1/mcp/webhooks/github`
