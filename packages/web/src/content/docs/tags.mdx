...
Every card with bars is **additive**: summing the bars reproduces the number above them, so the chart and the total can never tell different stories. Click the chevron to fold the header away.
