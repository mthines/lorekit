...
Then go break something. 😄 The next time your agent hits the same wall, watch it walk around it instead.

Want to give your agents a memory? Start with `npx @lorekit/cli install`, and read the [self-improvement loop guide](/docs/use-cases) for the full wiring. 👇
