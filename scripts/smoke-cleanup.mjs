 ...
 * `packages/smoke-tests/src/smoke-cleanup.ts`). That covers a suite that FAILED;
...
// MIRROR of SMOKE_ARTEFACT_PATTERN in packages/smoke-tests/src/smoke-cleanup.ts.
 ...
 *
 * Mirrors `smokeArtefactAgeMs` in packages/smoke-tests/src/smoke-cleanup.ts.
